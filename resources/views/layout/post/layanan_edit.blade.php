...
<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Update Laman Layanan</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Update Laman Layanan</h6>
        </div>
                                ...
                                <div class="col-10">
                                    <div class="form-floating mb-3">
                                        <input type="text" name="judul"
                                            ...
                                            placeholder="judul" value="{{old ('judul', $layanan -> judul)}}">
