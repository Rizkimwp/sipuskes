...
<div class="container-fluid">
    ...
    @endif
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Kelola Halaman Home</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kelola Home</h6>
        </div>
        <div class="col-2 m-3">
            <a href="{{ route('home.create') }}" class="btn-lg btn-primary"> Tambah </a>
        </div>
        <div class="card-body">
