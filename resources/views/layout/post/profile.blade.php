...
<div class="container-fluid">
    ...
    @endif
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Kelola Halaman Profile</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="col-2 m-3">
            <a href="{{ route('profile.create') }}" class="btn-lg btn-primary"> Tambah </a>
        </div>
        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <td>{{ $profile->id }}</td>
                                        ...
                                        <div class="col-3">
                                                <a href="{{ route('profile.index', $profile->id) }}"
