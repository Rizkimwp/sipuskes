...
<div class="container-fluid">
    ...
    @endif
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Kelola Halaman Layanan</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kelola Layanan</h6>
        </div>
        <div class="col-2 m-3">
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $layanan->id }}</td>
                                        <td>{{ $layanan->judul }}</td>
                                        <td>{{ $layanan->excerpt }}</td>
                                        <td class="row align-items-start">
                                            <div class="col-3">
                                                <a href="{{ route('layanan.index', $layanan->id) }}"
                                                    class="bg-info badge "> <i class="fas fa-fw fa-eye"
                                                        alt="view"></i></a>
                                            </div>
                                            <div class="col-3">
                                                <a href="{{ route('layanan.edit', $layanan->id) }}"
                                                    class="bg-warning badge "> <i class="fas fa-fw fa-marker"
                                                        alt="edit"></i></a>
                                            </div>
                                        </td>
