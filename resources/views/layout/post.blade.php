...
<div class="container-fluid">
    ...
    @endif
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Kelola Postingan</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kelola Postingan</h6>
        </div>
        <div class="col-2 m-3">
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            ...
                                            style="width: 73.2031px;">Categori Id</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                            style="width: 66.125px;">User Id</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                      <td>{{ $post->id }}</td>
                                        <td>{{ $post->judul}}</td>
                                        <td>{{ $post->excerpt }}</td>
                                        <td>{{ $post->categori->id }}</td>
                                        <td>{{ $post->user->id }}</td>
                                        <td class="row align-items-start">
                                        <div class="col-3">
                                                <a href="{{ route('profile.index', $post->id) }}"
