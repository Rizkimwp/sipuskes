...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Kelola Pegawai</h6>
        </div>
        <div class="col-2 m-3">
            <a href="{{ route('pegawai.create') }}" class="btn-lg btn-primary"> Tambah </a>
        </div>
        <div class="card-body">
                            ...
                            <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0"
                                ...
                                <thead>
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                            style="width: 66.125px;">Jabatan</th>
                                        <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1"
                                            colspan="1" aria-label="Salary: activate to sort column ascending"
                                        ...
                                        <div class="col-3">
                                                <a href="{{ route('pegawai.edit', $pegawai->id) }}"
                                                    class="bg-warning badge "> <i class="fas fa-fw fa-marker" alt="edit"></i></a>
                                                        ...
                                                        <div class="col">
                                                <form method="post" action="{{ route('pegawai.destroy', $pegawai->id) }}" class="d-inline"
