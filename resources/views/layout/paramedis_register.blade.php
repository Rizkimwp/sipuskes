@extends ('app')
@section('title', 'Tambah Paramedis')
@section('content')

<div class="container-fluid">
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Tambah Paramedis</h1>

    <!-- DataTales Example -->
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Paramedis</h6>
        </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        ...
                        <form method="post" action="{{ route('paramedis.store') }}">
                            @csrf
                            ...
                            <div class="col-8">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="alamat" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                                            value="{{old ('alamat')}}" placeholder="Tanggal Lahir ">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="number" name="no_tlp" class="form-control @error('spesialisasi') is-invalid @enderror"
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" name="spesialisasi" class="form-control @error('spesialisasi') is-invalid @enderror"
                                            id="floatingPassword" value="{{old ('spesialisasi')}}" placeholder="Password">
